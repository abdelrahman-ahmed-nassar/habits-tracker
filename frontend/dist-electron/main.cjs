...
function startBackend() {
  if (isDev) {
    ...
    console.log('Development mode: Backend should be running separately on port 5000');
    return;
  }
      ...
      submenu: [
        {
          ...
          click: () => {
            dialog.showMessageBox(mainWindow, {
              ...
              detail: 'A personal habit tracking application built with Electron and React.'
            });
          }
        },
        {
